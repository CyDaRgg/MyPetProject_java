...
//'controller' чтобы если при вытаскивании бина потом мы указали бы дед.class , то именем конкретизировали бы нужный бин, который реализует нужный класс(если классов несколько, например еще MarriageController extends MarriageController2)
